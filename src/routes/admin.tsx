      ...
      <div style={{ maxWidth: '700px', margin: '0 auto' }}>
        <div style={{ marginBottom: '2rem' }}>
          ...
          <p style={{ color: 'rgba(111,207,151,0.5)', fontSize: '13px', margin: 0 }}>
            Paste your Google Doc itinerary — Claude will extract the details automatically.
          </p>
        </div>
        ...
        <button
          ...
          style={{
            ...
            color: '#E8F5EE', border: 'none', borderRadius: '8px',
        ...
        {status === 'success' && result && (
          <div style={{
            ...
            <a href="/" style={{ display: 'inline-block', marginTop: '1rem', color: '#6FCF97', fontSize: '13px' }}>
              → View on homepage
            </a>
          </div>
        )}
